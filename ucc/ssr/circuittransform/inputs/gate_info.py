...
gate_depth_cx = {'cx':1, 'h':1, 't':1, 'x':1, 'y':1, 'z':1, 's':1, 'rx':1, 'ry':1,
...
## single-qubit gates.
gate_depth_cz = {'cx':1, 'h':1, 't':1, 'x':1, 'y':1, 'z':1, 's':1, 'rx':1, 'ry':1,
                 'rz':1, 'u3':1, 'tdg':1, 'swap':7, 'p':1, 'u2':1, 'u1':1, 'u':1,
                 'cz':1, 'sx':1}
